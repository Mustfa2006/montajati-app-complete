...
class OrderStatusHelper {
  ...
  static String getArabicStatus(String? databaseStatus) {
    ...
    // ✅ تقصير النصوص الطويلة - بسيط وبدون تعقيد
    switch (status) {
      // ✅ حالة خاصة: تقصير "قيد التوصيل في عهدة المندوب" إلى "قيد التوصيل"
      case 'قيد التوصيل الى الزبون (في عهدة المندوب)':
      case 'قيد التوصيل في عهد المندوب':
      case 'قيد التوصيل في عهدة المندوب':
        return 'قيد التوصيل'; // ✅ نص مختصر

      // باقي الحالات تُرجع كما هي
  ...
  static Color getStatusColor(String? databaseStatus) {
    ...
    if (status == 'تم تغيير محافظة الزبون' || status == 'تغيير المندوب') {
  ...
  static IconData getStatusIcon(String? databaseStatus) {
    ...
    if (status == 'تم تغيير محافظة الزبون' || status == 'تغيير المندوب' || status == 'نشط') {
      return Icons.check_circle_outline;
    }
